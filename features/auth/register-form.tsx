...
export function RegisterForm() {
  ...
  async function onSubmit(data: RegisterValues) {
    const res = await registerUser(data.email.trim(), data.password, data.fullName.trim());
    if (!res.success) {
      toast.error(res.error ?? "Registration failed");
      return;
    }
    toast.success("Account created in Firebase — let's set up your financial persona");
